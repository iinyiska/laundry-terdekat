  ...
  return (
    <main className="min-h-screen pb-32">
      ...
      <div className="fixed inset-0 -z-10">
        {settings.bg_theme === 'custom' && settings.custom_bg_url ? (
        ...
        ) : settings.bg_theme === 'blue' ? (
          <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #0c4a6e, #164e63)' }} />
        ) : settings.bg_theme === 'purple' ? (
          <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #4c1d95, #581c87)' }} />
        ) : (
