            ...
            <div className="w-full max-w-md">
                ...
                <div className="glass p-8 text-center">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-xl bg-white hover:bg-gray-100 transition text-gray-800 font-medium"
                    >
                        {loading ? (
                    ...
                    <p className="text-gray-500 text-sm mt-6">
                        ...
                        <span className="text-blue-400">Syarat & Ketentuan</span> kami
                    </p>
